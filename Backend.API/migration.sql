...
VALUES (N'c784d6e7-4424-4fe1-a1bb-b03c6a9a26cb', 0, N'2fe7f8d5-d321-4c77-884b-73ea438b1511', CAST(0 AS bit), N'joedoe@gmail.com', CAST(1 AS bit), N'Doe', CAST(1 AS bit), NULL, N'Joe', N'JOEDOE@GMAIL.COM', N'JOEDOE@GMAIL.COM', 'AQAAAAIAAYagAAAAEK1W3FMebsaQ5p6sqwXybnO6AdMcllqC99NBccKaS99FJZji0MmRjLfY4vMAR/ldRA==', N'0963233542', CAST(1 AS bit), NULL, '0001-01-01T00:00:00.0000000', '2023-012-05T21:28:39.0905955+03:30', N'LJNTPIYBD4KN2CFESBRMRL2YDQOXANQ4', CAST(0 AS bit), N'joedoe@gmail.com'),
(N'f0dccee8-a3e1-45f8-9bb7-f7e7decebd09', 0, N'6b263a8b-120f-4f48-a6bd-ad3a9c4c913d', CAST(0 AS bit), N'jilldoe@gmail.com', CAST(1 AS bit), N'Doe', CAST(1 AS bit), NULL, N'Jill', N'JILLDOE@GMAIL.COM', N'JILLDOE@GMAIL.COM', 'AQAAAAIAAYagAAAAEK1W3FMebsaQ5p6sqwXybnO6AdMcllqC99NBccKaS99FJZji0MmRjLfY4vMAR/ldRA==', N'0963233542', CAST(1 AS bit), NULL, '0001-01-01T00:00:00.0000000', '2023-012-05T21:28:39.0906005+03:30', N'OHACRUB556PUCIJOKNPX6QMTHA5G77DG', CAST(0 AS bit), N'jilldoe@gmail.com');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AccessFailedCount', N'ConcurrencyStamp', N'Disabled', N'Email', N'EmailConfirmed', N'Family', N'LockoutEnabled', N'LockoutEnd', N'Name', N'NormalizedEmail', N'NormalizedUserName', N'PasswordHash', N'PhoneNumber', N'PhoneNumberConfirmed', N'RefreshToken', N'RefreshTokenExpireTime', N'RegisterDate', N'SecurityStamp', N'TwoFactorEnabled', N'UserName') AND [object_id] = OBJECT_ID(N'[AspNetUsers]'))
...
VALUES (N'03B11179-8A33-4D3B-8092-463249F755A5', N'c784d6e7-4424-4fe1-a1bb-b03c6a9a26cb'),
