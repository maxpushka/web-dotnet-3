    ...
    public partial class InitializeDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "03B11179-8A33-4D3B-8092-463249F755A5", "ABCD1254-FEE2-42D0-A96E-E2018C9161BF", "user", "USER" },
                    { "CF0B61E1-3BB2-40D6-8E17-60CF475CE884", "D5FC26A2-75FD-45F8-AB88-DF4D337C5910", "admin", "ADMIN" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Disabled", "Email", "EmailConfirmed", "Family", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RefreshToken", "RefreshTokenExpireTime", "RegisterDate", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Permission", "Administrative.ViewUsers", "03B11179-8A33-4D3B-8092-463249F755A5" },
                    { 2, "Permission", "Administrative.ViewUsers", "CF0B61E1-3BB2-40D6-8E17-60CF475CE884" },
                    { 3, "Permission", "Administrative.ManageUsers", "CF0B61E1-3BB2-40D6-8E17-60CF475CE884" }
                });
